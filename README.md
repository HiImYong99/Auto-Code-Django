...
그 외에도 허용하지 않은 접근은 할 시 위와 같은 페이지가 나타납니다.
```
<br>
...
- 이번 프로젝트는 모놀리식 아키텍처를 선택하여 진행했는데 장단점을 확실히 알 수 있었습니다. 하나의 아키텍처로 이루어져 있어 빠른 개발 속도를 체감할 수 있었습니다. 하지만 하나에 모든것을 관리하기 때문에 서비스가 커진다면 유지 보수가 굉장히 힘들어지며 초기 개발속도의 장점이 사라질 수 있다는 생각을 했습니다.
